...
import { getVehiclePositionCacheStats, getVehiclePositionUpstreamStats,
  resetVehiclePositionCacheStats, resetVehiclePositionUpstreamStats } from './wmataVehiclePositions.js'

export { fetchGTFSVehiclePositions, parseGTFSVehiclePositions,
  resetWmataVehiclePositionCache } from './wmataVehiclePositions.js'
export type {
  RailCarriageDetails, RailVehicleCongestionLevel, RailVehicleOccupancyStatus,
  RailVehiclePosition, RailVehicleStopStatus, WmataVehiclePositionDependencies,
  WmataVehiclePositionFetcher,
} from './wmataVehiclePositions.js'
export { getGTFSTripProgress } from './wmataTripProgress.js'
export type { GtfsTripProgress, GtfsTripProgressStop } from './wmataTripProgress.js'
...
export function getWmataCacheStats() {
  return { ...cacheStats, ...getVehiclePositionCacheStats() }
}
...
export function resetWmataCacheStats() {
  ...
  resetVehiclePositionCacheStats()
}
...
export function getWmataUpstreamStats(): WmataUpstreamStats {
  ...
  const vehiclePositions = getVehiclePositionUpstreamStats()
...
export function resetWmataUpstreamStats(): void {
  ...
  resetVehiclePositionUpstreamStats()
}
