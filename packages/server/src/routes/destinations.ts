...
import { destinationSearchRateLimit, destinationResolveRateLimit } from '../middleware/rateLimit.js'
 ...
 */
router.get('/search', destinationSearchRateLimit, asyncHandler(async (req, res) => {
